...
def top_customer_data
  ...
  @invoice_item_6 = create(:invoice_item, quantity: 5, unit_price: @item_1.unit_price, item_id: @item_1.id, invoice_id: @invoice_6.id)
...
def ship_data
  ...
  @customer_2 = create(:customer)
  @customer_3 = create(:customer)
  @invoice_1 = @customer_1.invoices.create!(status: "completed", created_at: "2023-06-06 09:54:09 UTC")
  @invoice_2 = @customer_2.invoices.create!(status: "completed", created_at: "2023-06-06 10:54:09 UTC")
  @invoice_3 = @customer_3.invoices.create!(status: "completed", created_at: "2023-06-06 11:54:09 UTC")
